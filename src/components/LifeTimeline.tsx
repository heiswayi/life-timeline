...
const LifeTimeline: React.FC<LifeTimelineProps> = ({ className }) => {
    ...
    return [
      {
        ...
        description:
          "The thrill of balancing on two wheels for the first time—freedom unlocked!",
      ...
      },
      {
        ...
        description:
          "Nervous yet excited, stepping into a world of learning and friendship.",
      ...
      },
      {
        ...
        description:
          "A simple project turned into a proud moment—first taste of achievement.",
      ...
      },
      {
        ...
        description:
          "Butterflies, stolen glances, and a heart learning new emotions.",
      ...
      },
      {
        ...
        description:
          "A milestone filled with tears, joy, and endless possibilities ahead.",
      ...
      },
      {
        ...
        description:
          "Hard work paid off—first step into the professional world.",
      ...
      },
      {
        ...
        description:
          "Exploring new places, meeting new people, and growing as a person.",
      ...
      },
      {
        ...
        description:
          "Turning ideas into reality—something truly meaningful begins.",
      ...
      },
      {
        ...
        description:
          "Years of dedication recognized—stepping up to new challenges.",
  ...
  useEffect(() => {
    if (
      yearRange.earliestYear < config.startYear ||
      yearRange.latestYear > config.endYear
    ) {
      setConfig((prev) => ({
        ...prev,
  ...
  const [currentEvent, setCurrentEvent] = useState<Partial<LifeEvent> | null>(
    null
  );
  ...
  const handleSaveEvent = (event: LifeEvent) => {
    ...
    if (isNew) {
      setEvents(
        [...events, event].sort((a, b) => a.date.getTime() - b.date.getTime())
      );
      toast({
        title: "Event Added",
  ...
  const handleExportImage = async () => {
    ...
    try {
      ...
      toast({
        title: "Export failed",
        description:
          "There was an error creating your image. Please try again.",
        variant: "destructive",
      });
    }
  };
  ...
  return (
    <div className={cn("flex flex-col h-full", className)}>
      ...
      <div
        ref={timelineRef}
        className="overflow-x-auto overscroll-x-contain timeline-scrollbar bg-gradient-to-b from-background/40 to-background border cursor-move shadow-xl"
          ...
          {years.map((year, index) => (
            <div
              ...
              style={{
                ...
                opacity:
                  !config.showFutureYears && year > currentYear ? 0.3 : 1,
              }}
            >
              <YearMarker
                year={year}
      ...
      <span className="text-sm opacity-50 italic">
        <strong>Tip:</strong> Right-click on the event line to edit or delete
        it. <strong>Note:</strong> All data is stored locally in your browser's
        storage.
      </span>
          ...
          {sortedEvents.map((event) => (
            ...
            >
              <div className="flex items-center justify-between space-x-2">
                <div
                  className="h-1 w-full rounded-full flex-1"
                  style={{
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will delete all events and reset your timeline settings. This
